...
public class Constants {
	public static String VERSION = "2020.04.02.4";
	...
	public static final String PROJECT_JSON2CSV = "serialized/json2csv";
	public static final String PROJECT_DB2JSON_NODES = PROJECT_DB2JSON + "/nodes";
	public static final String PROJECT_DB2JSON_LINKS = PROJECT_DB2JSON + "/links";
	public static final String PROJECT_DB2JSON_LINK_PROPS = PROJECT_DB2JSON + "/linknodes";
	public static final String PROJECT_DB2JSON_LINGUISTICS = PROJECT_DB2JSON + "/en_sys_linguistics";
	public static final String PROJECT_DB2JSON_LINGUISTICS_GR_GR_COG = PROJECT_DB2JSON_LINGUISTICS + "/gr_gr_cog";
